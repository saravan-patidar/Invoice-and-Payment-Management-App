...
const ReportsDashboard = () => {
    ...
    const fetchTotalIncome = async () => {
        try {
            const response = await axios.get("http://localhost:3000/api/reports/total-income");
    ...
    const fetchOverduePayments = async () => {
        try {
            const response = await axios.get("http://localhost:3000/api/reports/overdue-payments");
    ...
    const fetchSalesData = async () => {
        ...
        try {
            const response = await axios.get(
                `http://localhost:3000/api/reports/sales?startDate=${startDate}&endDate=${endDate}`
            );
